          ...
          <Card className="border-gray-800 bg-[#1a1a1a]/50 backdrop-blur-sm">
            <CardContent className="p-8">
              <div className="grid gap-8 lg:grid-cols-2">
                {/* Playlist 1 */}
                <div className="relative flex flex-row items-start w-full min-h-[200px]">
                  {/* Left side: Music Icon + Controls */}
                  <div className="flex flex-row items-start w-full max-w-[60%]">
                    {/* Music Icon */}
                    <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#1DB954]/20 mt-2 mr-4 flex-shrink-0">
                  ...
                  {playlistImages[0] && (
                    <div className="absolute right-0 top-0 flex justify-end w-[40%]">
                      <img
